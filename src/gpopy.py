...
class Tunning():
    ...
    def run(self, save_model=False):
        ...
        for i in range(self.maximum_generation):
            ...
            print(
                f"##### Generation {i}   |   TopScore {self.top_score} #####")
    ...
    def score(self, save_model=False):
        ...
        for i in self.population:
            ...
            if save_model:
                ...
                if (score > self.top_score):
                    ...
                    print(
                        f"New optimal model founded with a score of {score} ")
                    print(
                        "###################################################################"
                    )
        ...
        self.generation += 1
        sorted_list = sorted(self.population,
...
class FlowTunning(Tunning):
    ...
    def __init__(self,
        ...
        """
        super().__init__(params, population_size, maximum_generation,
                         mutation_rate)
    ...
    def detailed_score(self, generation):
        ...
        for i, elem in enumerate(self.population):
            with mlflow.start_run():
                tags = {'generation': generation + 1, 'individue': i + 1}
